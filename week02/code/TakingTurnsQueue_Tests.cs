...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People with 1 turn remaining are not removed from queue. They should be removed after their last turn. 
    ...
    // Defect(s) Found: People with 1 turn remaining are not removed from queue. 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with turns <= 0 (infinite) are not re-added to queue. Also, people with 1 turn are not removed. 
    ...
    // Defect(s) Found: People with negative turns (infinite) are not re-added to queue. 
